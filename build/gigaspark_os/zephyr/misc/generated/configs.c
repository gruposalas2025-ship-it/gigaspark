...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_INFINEON_BT_HCI_UART_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 126);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_USB_COMMON, 1);

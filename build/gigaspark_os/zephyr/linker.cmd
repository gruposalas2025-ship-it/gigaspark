...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x8000000 + 0x40000), LENGTH = (0xc0000 - 0x0)
    RAM (wx) : ORIGIN = 0x24000000, LENGTH = (512 * 1K)
    ITCM ( rw ) : ORIGIN = (0), LENGTH = (65536) DTCM ( rw ) : ORIGIN = (536870912), LENGTH = (131072) EXTMEM ( rw ) : ORIGIN = (2415919104), LENGTH = (268435456) SRAM0 ( rw ) : ORIGIN = (603979776), LENGTH = (524288) SRAM1 ( rw ) : ORIGIN = (805306368), LENGTH = (131072) SRAM2 ( rw ) : ORIGIN = (805437440), LENGTH = (131072) SRAM3 ( rw ) : ORIGIN = (805568512), LENGTH = (32768) SRAM4_IPC ( rw ) : ORIGIN = (939524096), LENGTH = (65536) SDRAM1 ( rw ) : ORIGIN = (3221225472), LENGTH = (8388608)

...
const uintptr_t __irq_vector_table _irq_vector_table[127] = {
...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[127] = {
	...
	{(const void *)0x8109891, (ISR)0x8102f09}, /* 6 */
	{(const void *)0x810988f, (ISR)0x8102f09}, /* 7 */
	{(const void *)0x810988d, (ISR)0x8102f09}, /* 8 */
	{(const void *)0x810988b, (ISR)0x8102f09}, /* 9 */
	{(const void *)0x8109889, (ISR)0x8102f09}, /* 10 */
	...
	{(const void *)0x8109887, (ISR)0x8102f09}, /* 23 */
	...
	{(const void *)0x8109885, (ISR)0x8102f09}, /* 40 */
	...
	{(const void *)0x8108324, (ISR)0x810343d}, /* 126 */
};

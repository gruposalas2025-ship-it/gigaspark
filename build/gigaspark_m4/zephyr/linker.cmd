...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x8100000 + 0x0), LENGTH = (1024 * 1024 - 0x0 - 0x0)
    RAM (wx) : ORIGIN = 0x30000000, LENGTH = (128 * 1K)
    EXTMEM ( rw ) : ORIGIN = (2415919104), LENGTH = (268435456) SRAM0 ( rw ) : ORIGIN = (603979776), LENGTH = (524288) SRAM1 ( rw ) : ORIGIN = (805306368), LENGTH = (131072) SRAM2 ( rw ) : ORIGIN = (805437440), LENGTH = (131072) SRAM3 ( rw ) : ORIGIN = (805568512), LENGTH = (32768) SRAM4_IPC ( rw ) : ORIGIN = (939524096), LENGTH = (65536)
 ...
 *(.iplt)
 ...
 __rom_region_start = (0x8100000 + 0x0);
    rom_start :
 {
...
noinit (NOLOAD) :
{
    ...
    __kernel_ram_end = 0x30000000 + (128 * 1K);
